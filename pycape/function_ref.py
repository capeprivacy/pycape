...
class FunctionRef:
    ...
    Args:
        ...
        hash: Optional string denoting the function hash of the deployed Cape function.
            If supplied as part of a ``FunctionRef``, the :class:`~pycape.cape.Cape`
            client will verify that enclave responses include a matching function hash
